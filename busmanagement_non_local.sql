...
DROP TABLE IF EXISTS `non_local`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `non_local` (
  `PAS_ID` varchar(12) NOT NULL,
  `FOREIGN_PASSPORT` varchar(20) DEFAULT NULL,
  PRIMARY KEY (`PAS_ID`)
...
LOCK TABLES `non_local` WRITE;
/*!40000 ALTER TABLE `non_local` DISABLE KEYS */;
/*!40000 ALTER TABLE `non_local` ENABLE KEYS */;
UNLOCK TABLES;
